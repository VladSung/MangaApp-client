...
export const ManyUpload = ({ initialImages, height, width, resolution = '(800 x any px)', useFormContext }: Props) => {
    ...
    return (
        <>
            <Paper c='blue' withBorder h={height || 378} pos='relative' w={width || 253} radius='lg' style={{ zIndex: 0, borderColor: 'var(--mantine-color-primary-filled-filled)', borderStyle: 'dashed', overflow: 'hidden' }}>
